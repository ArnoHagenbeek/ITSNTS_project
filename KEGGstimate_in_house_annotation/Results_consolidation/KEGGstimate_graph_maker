#!/usr/bin/env python3
"""
Processes and merges all the KEGGstimate output in the provided directory, and visualizes them as a heatmap

Usage: (python) KEGGstimate_graph_maker.py --in_dir /directory/of/KEGGstimate/output --output plot_name.extension [arguments]
...
def completion_tsv_reader(filepath):
    """
    Parser function for reading the completion values in the KEGGstimate pipeline output.
...
if __name__ == "__main__":
    ...
    if "--output" in sys.argv:
        ...
        graphname = "KEGGstimate_heatmap.png"
        outformat = "png"
